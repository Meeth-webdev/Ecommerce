...
function page() {
  ...
  const [carousalItems, setcarousalItems] = useState<Product[]>([])
  ...
  return (
    ...
    <div className=''>
      ...
      <ShuffleDeck/>
      <TypingText />
      <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 pt-3 "
